package com.EATnBITE.mvc.controller;
	...
	if(validUser==null){
		...
		logger.debug("validUser is not null");
		 ...
		 //select * from proj2_profile_pics where username='adam';
	  	...
	  	try{
	  		String path="C:/Users/Ankur/workspace/Database/src/main/webapp/WEB-INF/resources/images/"+user.getUsername();
